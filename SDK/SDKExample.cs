...
namespace SDKExample
{
   ...
   public class SDKExample
   {
      ...
      public static void ProcessOrdersQuotesExample()
      {
         Console.WriteLine();
         Console.WriteLine("-----------------------------------");
         Console.WriteLine("Processing Orders and Quotes Example");
         Console.WriteLine("-----------------------------------");
         Console.WriteLine();
      ...
      public static void Main(string[] args)
      {
         ...
         SDKInstanceManager.Instance.SetAlertImplementation(new ConsoleAlert());
         Console.WriteLine("Enter file name of a sample Sage 50 data");
         Console.Write("> ");
         ...
         {
            Console.WriteLine("Not a valid Sage 50 data file.");
            return;
         }

         if (!File.Exists(saiFile))
         {
            Console.WriteLine("Sage 50 data file (.SAI) does not exist.");
            return;
         }
         ...
         {
            Console.WriteLine("Sage 50 data folder (.SAJ) does not exist.");
            return;
         }
